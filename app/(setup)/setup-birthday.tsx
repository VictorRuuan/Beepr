        ...
        {isUnder && (
          <View style={styles.warningBox}>
            <Text style={styles.warningText}>
              You must be 21+ to use this app. However, if you hold a valid
              medical cannabis card, you may continue.
            </Text>
            <TouchableOpacity
            ...
            >
              <View
                style={[styles.checkbox, hasCard && styles.checkboxChecked]}
              >
                {hasCard && (
              ...
              <Text style={styles.checkLabel}>
                I hold a valid medical cannabis card
              </Text>
            </TouchableOpacity>
          </View>
        )}
