...
const OPTIONS = [
  ...
  { key: 'vapes',        label: 'Vapes',        emoji: '💨' },
  { key: 'concentrates', label: 'Concentrates', emoji: '🧪' },
  { key: 'topicals',     label: 'Topicals',     emoji: '🧴' },
  { key: 'tinctures',    label: 'Tinctures',    emoji: '💧' },
  { key: 'pre-rolls',    label: 'Pre-Rolls',    emoji: '🌿' },
  { key: 'beverages',    label: 'Beverages',    emoji: '🥤' },
];

export default function SetupFormat() {
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.header}>
        <View />
        <TouchableOpacity onPress={() => router.push('/setup-effects')}>
          <Text style={styles.skip}>Skip</Text>
        </TouchableOpacity>
      </View>

      <View style={styles.container}>
        <Text style={styles.title}>What I'm looking for...</Text>
        <Text style={styles.subtitle}>Format</Text>
