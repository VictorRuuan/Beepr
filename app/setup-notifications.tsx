...
export default function SetupNotifications() {
  ...
  const [toastMsg, setToastMsg] = useState(`Notification radius set to ${radiusMiles} miles`);
    ...
    <View style={styles.safe}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.body}>
          Stay updated with order status, special offers, and personalized recommendations.
        </Text>
      </View>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalBox}>
            ...
            <Text style={styles.modalBody}>
              Beepr sends notifications about new product matches near you, order
              updates, and special promotions from your favorite dispensaries.
            </Text>
            ...
            <View style={styles.modalActions}>
              ...
              >
                <Text style={[styles.modalBtnText, styles.modalBtnAllow]}>Allow</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
